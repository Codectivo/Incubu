$(document).ready(function(){
    ...
    $("#submit_add_clave").click(function(){
        if(Incubu.key){
            var err_ms = "Ocurrio un error, estamos trabajando para resolverlo",
                ...
                data_send = {
                    'description': encrypt_str(description),
                    'user_account': encrypt_str(user),
                    'pass_account': encrypt_str(pass),
    ...
    $(".edit_account").click(function(){
        if(Incubu.key){
            var view = $(this),
                description = decrypt_str(view.attr('data-description')),
                user = decrypt_str(view.attr('data-user')),
                pass = decrypt_str(view.attr('data-pass'));
            $("#table_keys").hide();
            $("#add_key").fadeIn();
